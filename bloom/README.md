...
(http://godoc.org/github.com/qchain/btcutil/bloom)
...
```bash
$ go get -u github.com/qchain/btcutil/bloom
```

## Examples

* [NewFilter Example]
  (http://godoc.org/github.com/qchain/btcutil/bloom#example-NewFilter)  
